...
class Setting(models.Model):
    ...
    smtpserver = models.CharField(max_length=150,null=True,blank=True)
    smtpemail = models.CharField(max_length=150,null=True,blank=True)
    smtppassword = models.CharField(max_length=150,null=True,blank=True)
    smtpusername = models.CharField(max_length=150,null=True,blank=True)
    smtpport = models.CharField(max_length=150,null=True,blank=True)
    smtpsport = models.CharField(max_length=150,null=True,blank=True)
